            ...
            <div className="">
              ...
              <div className="can-do-pic">
                ...
                <p className='build-para'>
                  I like to keep it simple. My goals are to focus on<br />
                  functionality, content and making <br />it easy for end users.
                </p>
              </div>
              {/* dev para section */}
              <div className="dev-para">
                ...
                <div className="wrapper">
                  ...
                  <p className="dev-discription">
                    I'm a engineer, so i know how <br />
                    to create your applications to <br />
                    run across devices using <br />
          ...
          <div className="container_4">
            ...
            <h3 className='con4-title'>I'm currently available for work.</h3>
              ...
              <div className='con4-para'>
                  If you are looking for my skills and knowledge, <br/>or just want to say hey, then get in touch.
          
              </div>
            
            <ReactBootStrp.Button className='btn-messageMe'variant="primary" size="lg" active>
              MESSAGE ME
